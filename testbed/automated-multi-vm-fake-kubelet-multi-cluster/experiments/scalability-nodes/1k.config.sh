...
CLUSTER_CONFIGS=(
    "./clusters/1k-nodes/cluster-01.config.sh"
    "./clusters/1k-nodes/cluster-02.config.sh"
    "./clusters/1k-nodes/cluster-03.config.sh"
    "./clusters/1k-nodes/cluster-04.config.sh"
    "./clusters/1k-nodes/cluster-05.config.sh"
    "./clusters/1k-nodes/cluster-06.config.sh"
    "./clusters/1k-nodes/cluster-07.config.sh"
    "./clusters/1k-nodes/cluster-08.config.sh"
    "./clusters/1k-nodes/cluster-09.config.sh"
    "./clusters/1k-nodes/cluster-10.config.sh"
)
